...
- Download [**Pre-trained model**](/Model.h5) available on the internet and **haarcascade_frontalface.xml** files from above folder in the repository to your the local desktop.
